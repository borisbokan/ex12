...
public class SecondActivity extends Activity {
    ...
    private Button btnTrecaAktivnost;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //btnTrecaAktivnost=(Button)R.id.btnTrecaAktivnost;
    ...
    public void btnStartThirdActivityClicked(View view){
        Intent intThirdAct=new Intent();
        intThirdAct.setClass(SecondActivity.this,ThirdActivity.class);
        startActivity(intThirdAct);

    }
    //zadatak otvori kameru
    public void btnOpenCameraClicked(View view){
        Intent intCamera=new Intent();
        intCamera.setAction(MediaStore.ACTION_IMAGE_CAPTURE);
